...
class ReorientTaskCfg:
    """Task-level simulation and reward parameters for Phase-0."""
    ...
    reward_ori_scale: float = 1.0
    reward_dist_scale: float = 0.25
    reward_action_scale: float = 0.01
